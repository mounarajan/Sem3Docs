...
Mosts queries to the Semantics3 products API require that you supply a cat_id field. Refer to this [update](https://https://github.com/mounarajan/Sem3Docs/blob/master/APIDocs.md/#update-1-upc-lookups-91) for details.	
